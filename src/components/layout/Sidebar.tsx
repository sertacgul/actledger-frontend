  ...
  const NAV: { label: string; items: NavItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/insan-kaynaklari', icon: UserCog,      label: lang === 'tr' ? 'İnsan Kaynakları' : 'HR',      desc: lang === 'tr' ? 'Çalışan, izin ve bordro yönetimi' : 'Employee, leave and payroll management', minLevel: 4, moduleCode: 'HR' },
      ],
    },
  ]
