  ...
  const handleToggleKpi = async (kpi: Kpi) => {
    ...
    try {
      ...
      setAnalyses(prev => ({
        ...prev,
        [kpi.id]: lang === 'tr'
          ? 'Analiz olusturulurken hata olustu. Lutfen tekrar deneyin.'
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[10px] text-zinc-400 text-center pb-2">
        {lang === 'tr'
          ? 'KPI verileri departman bazinda guncellenmektedir. OperIQ analizleri yapay zeka tarafindan olusturulur.'
